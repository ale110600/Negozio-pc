	...
	public static void main(String[] args)
	{
				...
				do 
				{
					...
					case 0:
					{
						...
						//	{
						//		if (p.getIdentificativo()==Pc(j).getIdentificativo())
						...
						//	}while (i!=0);
							...
							p.setQuantitàDisponibile(tastiera.readInt());
					...
					case 2:
					{
						try
						{
							if (listaPc.eliminaComputer2()==1)
							{
							System.out.println("Eliminazione del pc eseguita con successo");
							try
							{
								System.out.println("Il nome e l'identificativo del pc verranno salvati sul file di testo pcEliminati.txt" );
								listaPc.esportaCSV2("pcEliminati.txt");
							}
							catch (IOException e)
							{
								System.out.println("Errore, non è possbile accedere al file");
					...
					try {
						...
						ArrayLista=ListaPc.OrdinaPcPerQuantitàDisponbile(ArrayLista);
					...
					case 7:
					{
						try
						{
							System.out.println(listaPc.VisualizzaPcQuantitàInferiore());
						}
						catch(NumberFormatException e)
						{
							System.out.println("Errore, inserimento di un dato non conforme ");
